...
public class PackInfo implements Serializable {
     ...
     * then, if the file is deleted in between.
     */
    public void addFile(File baseDir, File file, String targetfile, List<OsConstraint> osList, PackFile.OverrideType override, Blockable blockable, Map additionals, String condition)
