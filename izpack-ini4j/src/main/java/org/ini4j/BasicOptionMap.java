...
public class BasicOptionMap extends CommonMultiMap<String, String> implements OptionMap
{
    ...
    public void add(String key, Object value)
    {
        super.add(
                key,
                ((value == null) || (value instanceof String)) ? (String) value : String
                        .valueOf(value));
    }
    ...
    public <T> T fetchAll(Object key, Class<T> clazz)
    {
        ...
        {
            Array.set(value, i,
                    BeanTool.getInstance().parse(fetch(key, i), clazz.getComponentType()));
        }
    ...
    {
        return super.put(key, ((value == null) || (value instanceof String)) ? (String) value
    ...
    {
        if (!clazz.isArray()) { throw new IllegalArgumentException("Array required"); }
    }
