 ...
 * This class calls all declared panels for a summary
 * To differ between caption and message, HTML is used
 * to draw caption in bold and indent messaged a little
 * bit.
 *
 * @author  Klaus Bartz
 *
...
public class SummaryProcessor
{
  ...
  /**
   * Returns a HTML formated string which contains
   * the summary of all panels. To get the summary, the
   * methods  * {@link IzPanel#getSummaryCaption} and
   * {@link IzPanel#getSummaryBody()} of all panels are
   * called.
