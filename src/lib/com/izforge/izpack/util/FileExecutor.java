 ...
 * current package. After execution the file can be optionally removed.
 * Before execution on Unix systems execution flag will be set on processed
 * file.
 *
 *
...
public class FileExecutor
{
     ...
     * It will be launched once at command execution
     * end terminates if the apropriate stream runs
     * out of data.
     */
    ...
    private Collection files; // The files to execute
}
