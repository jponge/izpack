...
public class Shortcut
{
  ...
  public final static int START_MENU = 2;
  public final static int DESKTOP = 3;
  public final static int START_UP = 4;
   ...
   *  contructor because of the way it is instantiated through the <code>TargetFactory</code>
   *  .
   *
   * @param  type           the type or classification of the program group in
   *      which the link should exist.
   ...
   *  return true. The only version that can be expected to return false is this
   *  class itself, since it has no actual implementation for shortcut creation.
   *  This is left to OS specific flavors. If the installer is launched on a
   *  unsupported OS there will be no appropriate flavor of this class, which
   *  will cause this class itself to be instantiated. The client code can now
   *  determine by calling this method if the active OS is supported and take
   *  appropriate action.
   *
