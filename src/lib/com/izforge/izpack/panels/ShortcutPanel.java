 ...
 *  prompts the user to select a program group for shortcuts, accept the
 *  creation of desktop shortcuts and actually creates the shortcuts. <h4>
 *  Important</h4> It is neccesary that the installation has been completed
 *  before this panel is called. To successfully create shortcuts this panel
 *  needs to have the following in place: <br>
 *  <br>
 *
 *  <ul>
  ...
  ListSelectionListener
{
  ...
  // ------------------------------------------------------------------------
  private final static String LOCATION_APPLICATIONS = "applications";
  private final static String LOCATION_START_MENU = "startMenu";
   ...
   *  target system.
   */
  private final static String TEXT_FILE_NAME = "Shortcuts.txt";

  /**  The name of the XML file that specifies the shortcuts */
  private final static String SPEC_FILE_NAME = "shortcutSpec.xml";

  // ------------------------------------------------------
  // spec file section keys
  // ------------------------------------------------------
  private final static String SPEC_KEY_NOT_SUPPORTED = "notSupported";
  private final static String SPEC_KEY_PROGRAM_GROUP = "programGroup";
  private final static String SPEC_KEY_SHORTCUT = "shortcut";
  private final static String SPEC_KEY_PACKS = "createForPack";

  // ------------------------------------------------------
  // spec file key attributes
  // ------------------------------------------------------
  private final static String SPEC_ATTRIBUTE_DEFAULT_GROUP = "defaultName";
  private final static String SPEC_ATTRIBUTE_LOCATION = "location";
  private final static String SPEC_ATTRIBUTE_NAME = "name";
  private final static String SPEC_ATTRIBUTE_SUBGROUP = "subgroup";
  private final static String SPEC_ATTRIBUTE_DESCRIPTION = "description";
  private final static String SPEC_ATTRIBUTE_TARGET = "target";
  private final static String SPEC_ATTRIBUTE_COMMAND = "commandLine";
  private final static String SPEC_ATTRIBUTE_ICON = "iconFile";
  private final static String SPEC_ATTRIBUTE_ICON_INDEX = "iconIndex";
  private final static String SPEC_ATTRIBUTE_WORKING_DIR = "workingDirectory";
  private final static String SPEC_ATTRIBUTE_INITIAL_STATE = "initialState";
  private final static String SPEC_ATTRIBUTE_DESKTOP = "desktop";
  private final static String SPEC_ATTRIBUTE_APPLICATIONS = "applications";
  private final static String SPEC_ATTRIBUTE_START_MENU = "startMenu";
  private final static String SPEC_ATTRIBUTE_STARTUP = "startup";
  private final static String SPEC_ATTRIBUTE_PROGRAM_GROUP = "programGroup";

  // ------------------------------------------------------
  // spec file attribute values
  // ------------------------------------------------------
  private final static String SPEC_VALUE_APPLICATIONS = "applications";
  private final static String SPEC_VALUE_START_MENU = "startMenu";
  private final static String SPEC_VALUE_NO_SHOW = "noShow";
  private final static String SPEC_VALUE_NORMAL = "normal";
  private final static String SPEC_VALUE_MAXIMIZED = "maximized";
  private final static String SPEC_VALUE_MINIMIZED = "minimized";

  // ------------------------------------------------------
  // automatic script section keys
  // ------------------------------------------------------
  private final static String AUTO_KEY_PROGRAM_GROUP = "programGroup";
  private final static String AUTO_KEY_SHORTCUT = "shortcut";

  // ------------------------------------------------------
  // automatic script keys attributes
  // ------------------------------------------------------
  private final static String AUTO_ATTRIBUTE_NAME = "name";
  private final static String AUTO_ATTRIBUTE_GROUP = "group";
  private final static String AUTO_ATTRIBUTE_TYPE = "type";
  private final static String AUTO_ATTRIBUTE_COMMAND = "commandLine";
  private final static String AUTO_ATTRIBUTE_DESCRIPTION = "description";
  private final static String AUTO_ATTRIBUTE_ICON = "icon";
  private final static String AUTO_ATTRIBUTE_ICON_INDEX = "iconIndex";
  private final static String AUTO_ATTRIBUTE_INITIAL_STATE = "initialState";
  private final static String AUTO_ATTRIBUTE_TARGET = "target";
  private final static String AUTO_ATTRIBUTE_WORKING_DIR = "workingDirectory";
   ...
   */
  /**
   *  This method is called by the <code>groupList</code> when the user makes a
   *  selection. It updates the content of the <code>programGroup</code> with
   ...
   *
   * @param  packs  a <code>Vector</code> of <code>String</code>s. Each of the
   *      strings denotes a pack for which the schortcut should be created if
   ...
   *
   * @param  groups           A <code>Vector</code> that contains <code>Strings</code>
   *      with all the names of the existing program groups. These will be
   *      placed in the <code>groupList</code>.
   * @param  currentUserList  if <code>true</code> it indicates that the list of
   *      groups is valid for the current user, otherwise it is considered valid
   *      for all users.
   */
  /*
   *  --------------------------------------------------------------------------
   ...
   *  along with information about the intended targets. In addition, there is a
   *  button that allows the user to save more complete information in a text
